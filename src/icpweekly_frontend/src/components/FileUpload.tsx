...
// import { motoko_project_backend } from '../../../../declarations/icpweekly_backend';
...
// 	const uploadChunk = async ({ batch_name, chunk }: { batch_name: string; chunk: Blob }) =>
// 		await motoko_project_backend.fileupload.create_chunk({
// 			batch_name: batch_name,
// 			content: [...new Uint8Array(await chunk.arrayBuffer())],
// 		});

// 	const loadImage = (batch_name : string) => {
// 		if (!batch_name) {
// 			return;
// 		}
